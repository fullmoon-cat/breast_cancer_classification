...
public class Tester {
	...
	private static void calcDistTest(int[] pt1, int[] pt2, int testNum) {
		double actualOut = BreastCancerClassifySoln.calculateDistance(pt1, pt2);
	...
	private static void getAllDistTest(int[][] pts, int[] testpt, int testNum) {
		double[] actualOut = BreastCancerClassifySoln.getAllDistances(pts, testpt);
	...
	private static void kClosestTest(double[] dist, int testNum) {
		int[] actualOut = BreastCancerClassifySoln.findKClosestEntries(dist);
		boolean passed = true;
	...
	private static void classifyTest(int[][] pts, int[] kclosest, int testNum) {
		int actualOut = BreastCancerClassifySoln.classify(pts, kclosest);
		if(actualOut == 4) {
			passed(testNum);
		}
		else {
